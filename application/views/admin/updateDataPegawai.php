        ...
        <div class="card-body">
            ...
            <form action="<?php echo base_url('admin/dataPegawai/updateDataAksi')?>"  method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control"name="id_pegawai" value="<?php echo $peg->id_pegawai;?>">
                    <input type="text" class="form-control"name="nik" value="<?= $peg->nik;?>">
                    <?php echo form_error('nik','<div class="text-small text-danger"></div>');?>
                </div>
                <div class="form-group">
                    <label for="">Nama Pegawai</label>
                    <input type="text" class="form-control" name="nama_pegawai" value="<?= $peg->nama_pegawai;?>">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control"name="tanggal_masuk" value="<?= $peg->tanggal_masuk;?>">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="<?php echo base_url().'assets/photo/'.$peg->foto?>" alt="" width="60px" class="mb-3">
